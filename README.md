...
|---:|---|---|---|---|---|
| 1 | トレード心理研究 | 進行中 | 複数の受講生が同じチャート形状で入る場所を見つけ、成功/失敗の分岐を探す | P01「節目抜け・ブレイク飛び乗り」で画像照合162件/28名を抽出し、20枚シートで損失10件/利益10件を比較。 | 20枚シートに早い入口と待った入口を手動マーキングし、STOP/CHECK条件へ変換する |
