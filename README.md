...
|---:|---|---|---|---|---|
| 1 | トレード心理研究 | 進行中 | 複数の受講生が同じチャート形状で入る場所を見つけ、成功/失敗の分岐を探す | Simple v0.2を確認し、CHECK過多と表示の重さを確認。v0.3でCHECKを厳格化し、表示をS/W/Cへ短縮。 | TradingViewでSimple v0.3を確認し、候補が減ったか見る |
