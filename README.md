...
| 2 | **H4 Double V Reclaim / 初動V** | **最重要・可視化中** | [研究メモ](docs/research/h4_double_v_reclaim_2026-06-02.md) ／ [D1 V->H4確認](pine/visual/d1_v_context_h4_visual.pine) ／ [H4 Double V](pine/visual/h4_double_v_short_denial_visual.pine) ／ [Strategy](pine/production/h4_double_v_reclaim_strategy.pine) |
