...
|---:|---|---|---|---|---|
| 1 | トレード心理研究 | 進行中 | 複数の受講生が同じチャート形状で入る場所を見つけ、成功/失敗の分岐を探す | P01画像照合162件/28名から20枚をSTOP/CHECK暫定マーキングし、群衆心理シンプル版をv0.2へ更新。 | TradingViewでSimple v0.2のSTOP/CHECK表示を確認する |
