...
|---:|---|---|---|---|---|
| 1 | トレード心理研究 | 進行中 | 失敗トレードに共通する心理・判断・チャート形状を見つけ、最適エントリーパターンへ変換する | 匿名化705トレードを構造化。失敗パターン教材化、最適エントリー一次抽出、成功/失敗ペア比較、群衆心理検出器v0.2まで実施。 | TradingViewでFOMO、PANIC、WAIT/OUTの表示位置を確認する |
