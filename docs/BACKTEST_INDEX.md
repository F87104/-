...
| 19 | Elliott W5 v0.2 Filter | 2015-2024 / OOS | 46 | 39.1% | 1.97 | +20.6R | 5.0R | 🔬 目視照合候補 | OOS8件 PF1.20。3波伸び切り除外が核。単独採用しない |
...
| **Elliott 5波 フィルター改善 v0.2** | [`docs/research/elliott_wave5_filter_improvement_2026-06-09/REPORT_ja.md`](research/elliott_wave5_filter_improvement_2026-06-09/REPORT_ja.md) | 3波伸び切り除外、2波深戻し除外、ロング限定で改善を検証 | `LONG_W3_CAP_W2_MOD` はResearch PF1.97 / OOS PF1.20。ただしOOS8件で本番不可 |
