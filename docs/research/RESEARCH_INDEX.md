...
|---:|---|---|---|---|---|
| 1 | トレード心理研究 | 進行中 | 失敗トレードに共通する心理、判断、チャート形状を見つける | 匿名化、構造化、定量分析、失敗チャート分類、代表例7ケースの可視化、手動マーキング、教材化仕分け、優先教材3ケースの完成版までローカルで実施 | 完成版教材3ケースを目視確認し、受講者向けに表現を整える |
