...
| 2026-06-08 | **上位足戻し x 下位足H&S** | 新規仮説。上位足では戻しに見える場所を背景で出し、その中の下位足H&S/逆H&Sを後から確認するPine v0.6を追加。v0.6はEMA帯ではなく、上位足ダウ理論のHH/HL・LH/LLから直近推進波を判定し、38.2〜61.8%戻し帯をfill表示する。 | まずXAUUSDとUSDJPYで、D1ダウ戻し帯が人間の目に近いか確認する |
