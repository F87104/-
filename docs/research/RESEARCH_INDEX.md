...
1. 優先教材3ケースの文章を最終調整する
2. それぞれの教材に「入ってよい条件」「見送る条件」を追加する
3. 教材候補3ケースを補助教材にするか判断する
4. ニュース・指標系は別教材として扱うか決める
...
|---:|---|---|---|---|---|
| 1 | トレード心理研究 | 進行中 | 失敗トレードに共通する心理、判断、チャート形状を見つける | 匿名化、構造化、定量分析、失敗チャート分類、代表例7ケースの可視化、手動マーキング、教材化仕分けまでローカルで実施 | 優先教材3ケースを教材として使える形に整える |
