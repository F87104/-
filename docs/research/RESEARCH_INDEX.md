...
| 2026-06-08 | **上位足戻し x 下位足H&S** | 新規仮説。上位足では戻しに見える場所を背景で出し、その中の下位足H&S/逆H&Sを後から確認するPine v0.4を追加。v0.4は初期表示を「上位足の戻し部分だけ」に変更し、H&S関連ラベルは必要な時だけONにする。 | まずXAUUSDとUSDJPYで、D1戻し背景が人間の目に近いか確認する |
