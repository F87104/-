...
| 2026-06-08 | **上位足戻し x 下位足H&S** | 新規仮説。上位足では戻しに見える場所を背景で出し、その中の下位足H&S/逆H&Sとネックライン割れ/抜けを可視化するPine v0.2を追加。v0.2は背景初期OFF、形成途中LS/H初期OFFで、完成形だけを優先表示する。 | まずXAUUSDとUSDJPYで、上位足D1・表示足H4/H1の印が人間の目に近いか確認する |
