...
1. v2.x マトリクス戦略へ **F1 節目追い抑制** だけ移植（380件データで再確認）
2. v0.5 を教材として継続利用（赤=失敗 / 青=待つ）
...
|---:|---|---|---|---|---|
| 1 | 受講生つまずきクラスタ研究 | **データ確定** | 380件・全敗18・Pine v0.5 + F1試験 v0.1.1 完了 | 1期+2期座標抽出完了 | v2.x へ F1 移植 / 新規全敗期間で A/B |
