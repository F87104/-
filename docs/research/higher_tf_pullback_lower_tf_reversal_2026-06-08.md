...
## 事例2: USDJPY（D1 → H4 → H1 → M5）

保有中の **USDJPY 買い50**（4HT5）と同方向の構造例。

### D1 — 大局・押し目ゾーン

![USDJPY 日足 — 長期上昇・152付近押し目（実スクショ待ち）](images/mtf_pullback_reversal/2026-06-08_usdjpy_d1_pullback_context.png)

- 節目 **162.086** / **144.373**
- 2026年初頭 **152.5** 付近までの調整（オレンジ V字）→ 回復
