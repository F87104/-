...
| 11 | Lower High 3 Touch Breakdown | Short | 3つの高値切り下げ、下降ライン3回目タッチ、直近サポート下抜け | H3後の棚/安値ブレイク | ラインタッチだけで売らない。確定足後の下抜けとMFE/MAEを先に検証 | 新規仮説 2026-06-08 |
...
5. **Lower High 3 Touch Breakdown**
   - 3回の戻り高値切り下げ後、下抜けで買い手の損切りが出るかを見る。
   - 最初は売買せず、24/48/120本のMFE/MAEを測る。
