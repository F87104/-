# B06 SILVER — TV OANDA データでの Python 再実行
...
| 同一 signal_time | **0** |
| TVテスターと1日以内（TV-OHLC Python） | **0/2** |
...
- `python_expected_b06_tv_oanda_silver.csv`
- `b06_f87104_vs_tv_oanda_silver.csv`
- `b06_tv_oanda_vs_tester_silver.csv`
