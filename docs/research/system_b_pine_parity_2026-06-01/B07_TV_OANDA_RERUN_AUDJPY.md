# B07 AUDJPY — TV OANDA データでの Python 再実行
...
- `python_expected_b07_tv_oanda_audjpy.csv`
- `b07_f87104_vs_tv_oanda_audjpy.csv`
- `b07_tv_oanda_vs_tester_audjpy.csv`（テスターCSVがある場合）
