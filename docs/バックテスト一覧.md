...
| 検証 | パス | 概要 | 結論 |
|---|---|---|---|
| **研究ノート** | [`docs/research/ショート側研究_進行中_2026-05-28.md`](research/ショート側研究_進行中_2026-05-28.md) | ショート側検証の途中経過まとめ | まずここを読む |
...
| 検証 | パス | 概要 | 結論 |
|---|---|---|---|
| **研究メモ** | [`docs/research/H4_Vキックオフ触媒_2026-05-30.md`](research/H4_Vキックオフ触媒_2026-05-30.md) | Vを底買いではなく、相場拡大の触媒として再定義 | まずここを読む |
| **応用手法仕様整理** | [`docs/research/H4_V字回復戦略候補_2026-05-30.md`](research/H4_V字回復戦略候補_2026-05-30.md) | V字回復ロジックから派生手法を複数定義し、本命仕様を整理 | Pine化するならこの仕様を基準にする |
...
| 検証 | パス | 概要 | 結論 |
|---|---|---|---|
| **最終候補メモ** | [`docs/research/D1トラップ_H4棚厳選_2026-05-30.md`](research/D1トラップ_H4棚厳選_2026-05-30.md) | D1安値Trapを心理文脈にし、30-180日後のH4棚ブレイクを買う | 準本命。通常ロット前にPine照合とフォワード必須 |
...
| 検証 | パス | 概要 | 結論 |
|---|---|---|---|
| **研究メモ** | [`docs/research/市場心理スクイーズ厳選_2026-05-30.md`](research/市場心理スクイーズ厳選_2026-05-30.md) | ユーザー提示の Market Psychology Strategy をShort Squeeze/Capitulationに分解 | Squeeze strict はフォワード候補。Capitulation直買いは保留 |
| **通貨相性分析** | [`docs/research/市場心理スクイーズ通貨別相性_2026-05-30.md`](research/市場心理スクイーズ通貨別相性_2026-05-30.md) | SQZ strict/defaultを通貨別・組み合わせ別に確認 | XAUUSDが本命。USDJPY/AUDJPYが次点。GBPJPYは除外 |
...
| 検証 | パス | 結論 |
|---|---|---|
| 心理パターン辞書 | [`docs/research/市場心理パターンライブラリ_2026-05-30.md`](research/市場心理パターンライブラリ_2026-05-30.md) | Capitulation, Short Squeeze, Long Liquidation, Trap, Expectation Failure, Compression, FOMO, Relief Rally, Pain Trade, Dormant Breakoutを検証可能な条件に変換 |
...
| 検証 | パス | 結論 |
|---|---|---|
| 研究ノート | [`docs/research/トラップ_フォールスブレイク反応_2026-05-30.md`](research/トラップ_フォールスブレイク反応_2026-05-30.md) | H4 Trap単独は弱い。D1 120本級の節目否定だけが文脈候補 |
...
| 検証 | パス | 結論 |
|---|---|---|
| 研究ノート | [`docs/research/指標否定反応_2026-05-29.md`](research/指標否定反応_2026-05-29.md) | D1の下方向シグナル否定後ロングが候補 |
...
| 検証 | パス | 結論 |
|---|---|---|
| 研究ノート | [`docs/research/D1弱気トラップ_H4_V回収_2026-05-29.md`](research/D1弱気トラップ_H4_V回収_2026-05-29.md) | D1売り否定直後に買うより、直近D1売り否定なしが強い |
...
| Pineメモ | [`docs/research/H4_V回収Pine整理版_2026-05-29.md`](research/H4_V回収Pine整理版_2026-05-29.md) | Python照合手順とズレ要因 |
...
- 📘 [`戦略ガイド.md`](../戦略ガイド.md) — 戦略運用の説明書
- 📘 [`README.md`](../README.md) — リポジトリ入口
- 📘 [`docs/2本柱実用研究_2026-05-24.md`](2本柱実用研究_2026-05-24.md) — 公式総括
- 📘 [`docs/H4_T5_MACD_BB_実用監査_2026-05-24.md`](H4_T5_MACD_BB_実用監査_2026-05-24.md) — H4 T5 監査
- 📘 [`docs/H4_T5_本番運用ノート.md`](H4_T5_本番運用ノート.md) — H4 T5 運用ノート
